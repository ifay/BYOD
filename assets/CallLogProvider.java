...
public class CallLogProvider extends ContentProvider {
    ...
    /**
     * Same as {@link #getDatabaseModifier(android.database.sqlite.SQLiteDatabase)} but used for insert helper operations
     * only.
     */
    ...
    */
    ...
    private void syncEntriesFromPrimaryUser(UserManager userManager) {
        ...
        final Uri uri = ContentProvider.maybeAddUserId(Calls.CONTENT_URI,
