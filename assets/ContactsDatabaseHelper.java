...
//        ");");
    ...
    /**
     * Inserts a record in the {@link ContactsDatabaseHelper.Tables#NAME_LOOKUP} table.
     */
    ...
    /**
     * Upgrades the database with the new value for {@link android.provider.ContactsContract.PinnedPositions#UNPINNED}. In this
    ...
    /**
     * Return the {@link android.content.pm.ApplicationInfo#uid} for the given package name.
     */
    ...
    /**
     * Convert a package name into an integer, using {@link ContactsDatabaseHelper.Tables#PACKAGES} for
    ...
    /**
     * Convert a mimetype into an integer, using {@link ContactsDatabaseHelper.Tables#MIMETYPES} for
     * lookups and possible allocation of new IDs as needed.
     */
    ...
    /**
     * Find the mimetype for the given {@link android.provider.ContactsContract.Data#_ID}.
     */
    ...
    /**
     * Update {@link android.provider.ContactsContract.Contacts#IN_VISIBLE_GROUP} for all contacts.
     */
    ...
    /**
     * Update {@link android.provider.ContactsContract.Contacts#IN_VISIBLE_GROUP} and
     * {@link ContactsDatabaseHelper.Tables#DEFAULT_DIRECTORY} for a specific contact.
     */
     ...
     * is defined by {@link ContactsDatabaseHelper.Clauses#CONTACT_IS_VISIBLE}.
     *
    ...
    /**
     * Returns the value from the {@link ContactsDatabaseHelper.Tables#PROPERTIES} table.
     */
    ...
    /**
     * Stores a key-value pair in the {@link ContactsDatabaseHelper.Tables#PROPERTIES} table.
     */
    ...
    /**
     * Resets the {@link android.provider.ContactsContract.RawContacts#NAME_VERIFIED} flag to 0 on all other raw
    ...
    /**
     * Deletes all {@link ContactsDatabaseHelper.Tables#NAME_LOOKUP} table rows associated with the specified data element.
     */
