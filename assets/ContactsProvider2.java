 ...
 * is defined in {@link android.provider.ContactsContract}.
 */
public class ContactsProvider2 extends AbstractContactsProvider
    ...
    /**
     * Used for Strequent URI with {@link android.provider.ContactsContract#STREQUENT_PHONE_ONLY}, which allows
     * users to obtain part of Data columns. We hard-code {@link android.provider.ContactsContract.Contacts#IS_USER_PROFILE} to NULL,
    ...
    /** Contains the just the {@link android.provider.ContactsContract.Groups} columns */
    ...
    /**
     * Contains {@link android.provider.ContactsContract.Groups} columns along with summary details.
     *
     * Note {@link android.provider.ContactsContract.Groups#SUMMARY_COUNT} doesn't exist in groups/view_groups.
    ...
    /** Contains {@link android.provider.ContactsContract.Directory} columns */
    ...
    /**
     * Map from group source IDs to lists of {@link ContactsProvider2.GroupIdCacheEntry}s.
     *
     ...
     *
     * @param uri Current {@link android.net.Uri} being operated on.
     * @param values {@link android.content.ContentValues} to read and possibly update.
     * @throws IllegalArgumentException when only one of
     *             {@link android.provider.ContactsContract.RawContacts#ACCOUNT_NAME} or
     *             {@link android.provider.ContactsContract.RawContacts#ACCOUNT_TYPE} is specified, leaving the
     *             other undefined.
     * @throws IllegalArgumentException when {@link android.provider.ContactsContract.RawContacts#ACCOUNT_NAME}
     *             and {@link android.provider.ContactsContract.RawContacts#ACCOUNT_TYPE} are inconsistent between
     *             the given {@link android.net.Uri} and {@link android.content.ContentValues}.
     */
    ...
    /**
     * Processes the photo contained in the {@link android.provider.ContactsContract.StreamItemPhotos#PHOTO} field of the given
    ...
    private long insertSettings(ContentValues values) {
        ...
        Builder settingsUri = Settings.CONTENT_URI.buildUpon();
        if (accountName != null) {
    ...
    /**
     * Handles {@link android.provider.ContactsContract.PhoneLookup#ENTERPRISE_CONTENT_FILTER_URI}.
     */
    // TODO Test
    ...
    /**
     * Rewrite a cursor from the corp profile for {@link android.provider.ContactsContract.PhoneLookup#ENTERPRISE_CONTENT_FILTER_URI}.
     */
    @VisibleForTesting
    static Cursor rewriteCorpPhoneLookup(Cursor original) {
        ...
        while (original.moveToNext()) {
            ...
            final RowBuilder builder = ret.newRow();
    ...
    /**
     * Generate a photo URI for {@link android.provider.ContactsContract.PhoneLookup#PHOTO_THUMBNAIL_URI}.
     *
    ...
    /**
     * Generate a photo URI for {@link android.provider.ContactsContract.PhoneLookup#PHOTO_URI}.
     *
     ...
     * will be appended to a {@link android.database.Cursor} as extras.
     */
    ...
    /**
     * Output {@link android.provider.ContactsContract.RawContacts} matching the requested selection in the vCard
     ...
     * with {@link android.provider.ContactsContract#PRIMARY_ACCOUNT_NAME} and
     * {@link android.provider.ContactsContract#PRIMARY_ACCOUNT_TYPE}. Null will be returned when the primary
     ...
     *
     * @param values The {@link android.content.ContentValues} object to operate on.
     */
